...
export default async function SubsPage() {
  ...
  if (!subs.length) subs = [
    { id: "s1", user_id: "1", plan: "monthly", status: "active", current_period_end: new Date(Date.now() + 20 * 86400000).toISOString() },
    { id: "s2", user_id: "2", plan: "yearly", status: "active", current_period_end: new Date(Date.now() + 200 * 86400000).toISOString() },
